        ...
        <main class="verification-main">
            <div class="verification-card">
                ...
                <div class="verification-status">
                    ...
                    <?php elseif ($verification_status === 'tampered'): ?>
                        <h2 class="tampered">DOCUMENT MODIFIÉ</h2>
                        <p class="verification-message">
                            Attention: Ce document a été modifié après sa création.
                        </p>
                    <?php else: ?>
                    ...
                    <div class="document-verification-details">
                        ...
                        <div class="details-grid">
                            <div class="detail-item">
                                ...
                                <span><?php echo htmlspecialchars($document['reference']); ?></span>
                            </div>
                            <div class="detail-item">
                                <strong>Titre:</strong>
                            ...
                            <div class="detail-item">
                                ...
                                <span><?php echo htmlspecialchars($document['cabinet']); ?></span>
                            </div>
                            <div class="detail-item">
                                <strong>Date du Document:</strong>
                                <span><?php echo date('d/m/Y', strtotime($document['date_document'])); ?></span>
                            </div>
                            <div class="detail-item">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="badge badge-success"><?php echo ucfirst($document['statut']); ?></span>
                            </div>
                        </div>
                        
                        <div class="verification-hash">
                            <p><strong>Hash de vérification:</strong></p>
